...
TEST_IMAGE = "/mnt/c/temp/cover.png"
...
def run(rendering_method: str = "auto") -> None:
    ...
    table_demo_table.add_row(
        "Grace Hopper",
        "December 9, 1906",
        Image(TEST_IMAGE, width="auto", height="auto"),
    )
    table.add_row("Images in tables", table_demo_table)

    table.add_row(
        "... and in panels",
        Panel(Image(TEST_IMAGE, width=20, height="auto"), expand=False),
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--method", choices=RENDERING_METHODS.keys(), default="auto"
    )
